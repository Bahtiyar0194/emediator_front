export default {
    ...
    errors: {
        ...
        sigex: {
            iin: "Документ могут подписать только указанные в нём стороны. Пожалуйста, убедитесь, что вы используете ЭЦП, оформленную на ИИН одной из сторон или её официального представителя. Если ключ выбран верно, убедитесь в том правильно ли указаны ИИН сторон в самом документе."
        }
    },
    ...
    form: {
        ...
        attorney: {
            ...
            representative: 'Представитель стороны {index}',
