export default {
    ...
    errors: {
        ...
        sigex: {
            iin: "Құжатқа тек онда көрсетілген тараптар ғана қол қоя алады. Тараптардың бірінің немесе оның ресми өкілінің ЖСН-на ресімделген ЭЦҚ пайдаланғаныңызға көз жеткізуіңізді өтінеміз. Егер ЭЦҚ дұрыс таңдалса, құжаттың өзінде тараптардың ЖСН дұрыс көрсетілгенін тексеріңіз."
        }
    },
