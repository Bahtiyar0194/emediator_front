      ...
      <div class="custom-grid">
        ...
        <div class="col-span-12">
          <div class="form-group-border select active label-active">
            ...
            <select v-model="child.residential_address">
              <option disabled selected value="">
                {{ $t("form.residential_address.select") }}
              </option>
              <option :value="1">
                {{ docData.last_name_1 }} {{ docData.first_name_1 }} ({{
                  $t("pages.documents.party_1")
                }})
              </option>
              <option :value="2">
                {{ docData.last_name_2 }} {{ docData.first_name_2 }} ({{
                  $t("pages.documents.party_2")
                }})
              </option>
            </select>
            <label
              :class="{
                'label-error':
                  errors[
                    `agreement_data.children.${index}.${'residential_address'}`
                  ],
              }"
            >
              {{
                errors[
                  ...
                  ? $t("form.residential_address.required")
                  : $t("form.residential_address.title")
              }}
            </label>
          </div>
        </div>
