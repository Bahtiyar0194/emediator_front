<template>
  <div class="custom-grid">
      ...
      <div class="custom-grid">
        <div class="col-span-12 lg:col-span-3">
          <div class="form-group-border active">
            ...
            <input
              v-model="docData.last_name_1"
              type="text"
              placeholder=" "
            />
            <label :class="{ 'label-error': errors.last_name_1 }">
              {{
                errors.last_name_1
        ...
        <div class="col-span-12 lg:col-span-3">
          <div class="form-group-border active">
            <i class="pi pi-user"></i>
            <input
              v-model="docData.first_name_1"
              type="text"
              placeholder=" "
            />
            <label :class="{ 'label-error': errors.first_name_1 }">
              {{
                errors.first_name_1
        ...
        <div class="col-span-12 lg:col-span-3">
          <div class="form-group-border active">
            <i class="pi pi-user"></i>
            <input
              v-model="docData.iin_1"
              v-mask="'############'"
              placeholder=" "
            />
            <label :class="{ 'label-error': errors.iin_1 }">
              {{
                errors.iin_1 ? $t("form.iin.required") : $t("form.iin.title")
              }}
            </label>
          </div>
        </div>
          ...
          <div class="custom-grid">
            <div class="col-span-12 lg:col-span-4">
              <div class="form-group-border active">
                ...
                <input v-model="docData.street_1" placeholder=" " />
                <label :class="{ 'label-error': errors.street_1 }">
                  {{
                    errors.street_1
            ...
            <div class="col-span-12 lg:col-span-4">
              <div class="form-group-border active">
                ...
                <input
                  v-model="docData.house_1"
                  type="number"
                  placeholder=" "
                />
                <label :class="{ 'label-error': errors.house_1 }">
                  {{
                    errors.house_1
    ...
    <div v-if="docData.is_legal_1 === true" class="col-span-12">
      <div class="custom-grid">
        ...
        <div v-if="legalForms.length > 0" class="col-span-12 lg:col-span-3">
          <div class="form-group-border select active label-active">
            ...
            <select v-model.number="docData.legal_form_id_1">
            ...
            <label
              :class="{
                'label-error': errors.legal_form_id_1,
              }"
            >
              {{
                errors.legal_form_id_1
                  ? $t("form.select_legal_form")
                  : $t("form.legal_form")
              }}
            </label>
        ...
        <div v-if="posts.length > 0" class="col-span-12 lg:col-span-3">
          <div class="form-group-border select active label-active">
            <i class="pi pi-id-card"></i>
            <select v-model.number="docData.post_type_id_1">
              <option disabled :value="null">
                {{ $t("form.select_post") }}
              </option>
              <option
            ...
            <label
              :class="{
                'label-error': errors.post_type_id_1,
              }"
            >
              {{
                errors.post_type_id_1 ? $t("form.select_post") : $t("form.post")
              }}
            </label>
          </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-3">
          <div class="form-group-border active">
            <i class="pi pi-id-card"></i>
            <input
              v-model="docData.bin_1"
              v-mask="'############'"
              placeholder=" "
            />
            <label :class="{ 'label-error': errors.bin_1 }">
              {{
                errors.bin_1 ? $t("form.bin.required") : $t("form.bin.title")
              }}
            </label>
          </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-3">
          <div class="form-group-border active">
            ...
            <input
              v-model="docData.company_name_1"
              type="text"
              placeholder=" "
            />
            <label :class="{ 'label-error': errors.company_name_1 }">
              {{
        ...
        <div class="col-span-12">
          <div class="custom-grid">
            <div class="col-span-12 lg:col-span-4">
              <div class="form-group-border active">
                <i class="bi bi-signpost-split"></i>
                <input v-model="docData.company_street_1" placeholder=" " />
                <label :class="{ 'label-error': errors.company_street_1 }">
                  {{
                    errors.company_street_1
                      ? $t("form.street.required")
                      : $t("form.street.title")
                  }}
                </label>
            ...
            <div class="col-span-12 lg:col-span-4">
              <div class="form-group-border active">
                ...
                <input
                  v-model="docData.company_building_1"
                  type="number"
                  placeholder=" "
                />
                <label :class="{ 'label-error': errors.company_building_1 }">
                  {{
                    errors.company_building_1
            ...
            <div class="col-span-12 lg:col-span-4">
              <div class="form-group-border active">
                <i class="bi bi-door-open"></i>
                <input
                  v-model="docData.company_cabinet_1"
                  type="number"
                  placeholder=" "
                />
                <label>
...
const {
  ...
  treeRef: locations,
  modelRef: docData,
  modelKey: "company_location_id_1",
});
